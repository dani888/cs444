...
typedef enum process_number {user1 = 1, user2, user3} process;
PEntry proctab[NPROC], *curproc; /* process table / points to current process */
...
#define MAX_CALL 6
#define esp1 0x290000 /* process 1 stack starting address */
#define esp2 0x299000 /* process 2 stack starting address */
#define esp3 0x299900 /* process 3 stack starting address */
...
void process_table() {
  ...
  proctab[user1].p_savedregs[SAVED_PC] = (int) &ustart1;
  proctab[user2].p_savedregs[SAVED_PC] = (int) &ustart2;
  proctab[user3].p_savedregs[SAVED_PC] = (int) &ustart3;

  proctab[user1].p_savedregs[SAVED_ESP] = esp1;
  proctab[user2].p_savedregs[SAVED_ESP] = esp2;
  proctab[user3].p_savedregs[SAVED_ESP] = esp3;
